...
(function (b) {
    var a = {init:function (c) {
        return this.each(function () {
            var g = b(this);
            g.data("uploadifive", {inputs:{}, inputCount:0, fileID:0, queue:{count:0, selected:0, replaced:0, errors:0, queued:0, cancelled:0}, uploads:{current:0, attempts:0, successful:0, errors:0, count:0}});
            var d = g.data("uploadifive");
            var f = d.settings = b.extend({auto:true, buttonClass:false, buttonText:"Select Files", checkScript:false, dnd:true, dropTarget:false, fileSizeLimit:0, fileType:false, formData:{}, height:30, method:"post", multi:true, overrideEvents:[], queueID:false, queueSizeLimit:0, removeCompleted:false, simUploadLimit:0, truncateLength:0, uploadLimit:0, uploadScript:"uploadifive.php", width:100}, c);
            ...
            d.inputTemplate = b('<input type="file">').css({opacity:0, position:"absolute", "z-index":999});
                ...
                if (!k.skip && !k.complete && !k.uploading) {
                    ...
                    if (typeof FormData === "function" || typeof FormData === "object") {
                            ...
                            if (this.readyState == 4) {
                                ...
                                if (this.status == 200) {
                                    ...
                                    if (this.status == 404) {
                                        ...
                                        if (this.status == 403) {
                                            d.error("403_FORBIDDEN", k, uplaodAll);
                                        } else {
                        ...
                        j.onload = function (q) {
                            ...
                            s += p + t + o;
                            s += 'Content-Disposition: form-data; name="Filedata"';
                            if (k.name) {
                                s += '; filename="' + k.name + '"';
                            }
                            s += o;
            ...
            if (window.File && window.FileList && window.Blob && (window.FileReader || window.FormData)) {
                ...
                d.button.css({height:f.height, "line-height":f.height + "px", overflow:"hidden", position:"relative", "text-align":"center", width:f.width});
                g.before(d.button).appendTo(d.button).hide();
                d.createInput.call(g);
                d.button.mousemove(function (j) {
                    var k = d.button.offset();
                    d.currentInput.css({left:j.pageX - k.left - g.width() + 10, top:j.pageY - k.top - g.height() + 10});
                });
                if (!f.queueID) {
        ...
        this.each(function () {
            ...
            if (typeof e.onClearQueue === "function") {
                e.onClearQueue.call(f, b("#" + c.options.queueID));
            }
        });
    }, cancel:function (d, c) {
        this.each(function () {
