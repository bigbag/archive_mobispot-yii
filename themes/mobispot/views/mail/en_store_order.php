...
<table style="width:100%;" cellspacing="0">
    ...
    <tr>
        <td style="border-top:1px solid #bfbfbf; padding:20px 0;"><?php echo $item["name"]; ?><br/><?php echo empty($item["code"])?'':$item["code"]; ?></td>
        <td style="border-top:1px solid #bfbfbf;">
            <?php if (!empty($item["color"])): ?>
                <img src="<?php echo $this->getBaseUrl(); ?>/themes/mobispot/images/mail/store/color-<?php echo $item["color"]; ?>.png" />
            <?php endif; ?>
        </td>
        <td style="border-top:1px solid #bfbfbf;">
            <?php if (!empty($item["size_name"]) and $item["size_name"] != 'standart'): ?>
...
<?php //<div style="margin-top:70px;"><a href="#"><img src="<?php echo $this->getBaseUrl(); ?><?php ///themes/mobispot/images/mail/store/dare_to_share.png"></a></div> ?>
<table style="margin-top:40px; width:100%;">
    <tr>
        ...
        <td><a href="https://www.facebook.com/heyMobispot"><img src="<?php echo $this->getBaseUrl(); ?>/themes/mobispot/images/mail/store/fb.png"></a></td>
        <td><a href="https://twitter.com/heymobispot"><img src="<?php echo $this->getBaseUrl(); ?>/themes/mobispot/images/mail/store/twitter.png"></a></td>
    </tr>
    <tr><?php //<td><a href="#" style="color:black;">Unsubscribe</a>?></td><td colspan="2"></td></tr>
</table>
</body>
</html>
