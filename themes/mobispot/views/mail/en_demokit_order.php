<div bgcolor="#ffffff" style="padding:30px 0;margin:0; width:660px;  font-family:Arial, sans-serif;font-size:12pt;">
    ...
    <table style="width:100%;border:0;" cellspacing="0">
        ...
        <tr>
            ...
            <td colspan="2" style="border-top:1px solid #bfbfbf;">
                <img src="<?php echo $this->getBaseUrl(); ?>/themes/mobispot/images/mail/store/tracking_number.png" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="border-top:1px solid #bfbfbf;">
                <img src="<?php echo $this->getBaseUrl(); ?>/themes/mobispot/images/mail/store/color.png" />
            </td>
            <td style="border-top:1px solid #bfbfbf;">
                <img src="<?php echo $this->getBaseUrl(); ?>/themes/mobispot/images/mail/store/size.png" />
            </td>
            <td style="border-top:1px solid #bfbfbf;">
                <img src="<?php echo $this->getBaseUrl(); ?>/themes/mobispot/images/mail/store/price.png" />
            </td>
            <td style="border-top:1px solid #bfbfbf;">
        ...
        <tr>
            <td>
                <img src="<?php echo $this->getBaseUrl(); ?>/themes/mobispot/images/mail/store/tax.png" /></td>
                <td></td>
                <td colspan="3"></td>
        </tr>
        <tr>
