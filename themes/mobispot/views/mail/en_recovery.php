...
<div style="padding-top:30px">
    <p>Dear user,</p>
    <p style="line-height: 1.2">To resset your password please click the button below.</p>
</div>
<a target="_blank" href="<?php echo $activation_url; ?>">
    <img width=329 alt="Reset the password" style="margin:25px 0" src="http://mobispot.com/themes/mobispot/images/mail/en_reset_password_button.png"/>
</a>
