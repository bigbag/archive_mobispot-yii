...
<div style="background:#f1f3f4; padding:30px; width:600px;">
	<h2 style="color: #0062ff;font-size:1.9em;">Комментарий к споту <?php echo $spot_id?></h2>

	<p>К вашему споту <?php echo $spot_id?>, оставлен новый комментарий:</p>
    <p><?php echo nl2br(CHtml::encode($comment))?></p>
</div>
