<table cellpadding="0" cellspacing="0" border="0" align="center">
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    <td rowspan="3" width="150" valign="top" align="left" style="padding:5px;">
                        <img src="{{params.photo}}" style="border:1px solid #cccccc;border-radius:15px;" alt="" width="106" height="106" />
                    </td>
                    <td height="20" style="padding:0px 0px 5px 40px;font-size: 12px;color: #707070;font-family:Helvetica;">
                        {% if params.date %}
                ...
                <tr>
                    <td height="85" width="400" style="border-radius:25px;background:#a6d9a1;color:#ffffff;font-family:Helvetica;" align="center">
                        {% if params.comment %}
                        {{params.comment}}
                        {% endif %}
                    </td>
    ...
    <tr>
        <td align="center" height="100" valign="middle" style="color: #999999;font-size: 10px;font-weight: bold;font-family:Helvetica;">
            Mobispot
        </td>
    </tr>
</table>