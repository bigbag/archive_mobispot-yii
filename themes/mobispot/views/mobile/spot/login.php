                ...
                <form name="loginForm">
                    ...
                    <a class="form-link" href="#b_forgot"><?php echo Yii::t('user', 'Forgot password?'); ?></a>
                        ...
                        <p><?php echo Yii::t('user', 'login with'); ?></p>
                            <a href="javacript:;"><img src='/themes/mobile/images/icons/google-i_x2.png'></a>
                            <a href="javacript:;"><img src='/themes/mobile/images/icons/twi-i_x2.png'></a>
                            <a href="javacript:;"><img src='/themes/mobile/images/icons/fb-i_x2.png'></a>
                        </div>
