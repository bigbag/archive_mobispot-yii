    ...
    <a class="<?php
        ...
        href="javascript:;"><img width="36" src="<?php echo MHttp::desktopHost(); ?>/themes/mobispot/socialmediaicons/linkedin.png"> </a>
    <a class="<?php
        echo (SocInfo::nameInList('foursquare', $spotNets))?        'link':''
        ?>"
        title="Foursquare"
        ng-click="bindByPanel('foursquare')"
        href="javascript:;"><img width="36" src="<?php echo MHttp::desktopHost(); ?>/themes/mobispot/socialmediaicons/foursquare.png"> </a>
    <a class="<?php
        echo (SocInfo::nameInList('google_oauth', $spotNets))?        'link':''
        ?>"
        title="Google+"
        ng-click="bindByPanel('google_oauth')"
        href="javascript:;"><img width="36" src="<?php echo MHttp::desktopHost(); ?>/themes/mobispot/socialmediaicons/google.png"> </a>
    <a class="<?php
        echo (SocInfo::nameInList('YouTube', $spotNets))?        'link':''
        ?>"
        title="YouTube"
        ng-click="bindByPanel('YouTube')"
        href="javascript:;"><img width="36" src="<?php echo MHttp::desktopHost(); ?>/themes/mobispot/socialmediaicons/youtube.png"> </a>
    <a class="<?php
        echo (SocInfo::nameInList('vimeo', $spotNets))?        'link':''
        ?>"
        title="Vimeo"
        ng-click="bindByPanel('vimeo')"
        href="javascript:;"><img width="36" src="<?php echo MHttp::desktopHost(); ?>/themes/mobispot/socialmediaicons/vimeo.png"> </a>
    <a class="<?php
        echo (SocInfo::nameInList('vk', $spotNets))?        'link':''
        ?>"
        title="VKontakte"
        ng-click="bindByPanel('vk')"
        href="javascript:;"><img width="36" src="<?php echo MHttp::desktopHost(); ?>/themes/mobispot/socialmediaicons/vk.png"> </a>
    <a class="<?php
        echo (SocInfo::nameInList('Behance', $spotNets))?        'link':''
        ?>"
        title="Behance"
        ng-click="bindByPanel('Behance')"
        href="javascript:;"><img width="36" src="<?php echo MHttp::desktopHost(); ?>/themes/mobispot/socialmediaicons/behance.png"> </a>
    <a class="<?php
        echo (SocInfo::nameInList('deviantart', $spotNets))?        'link':''
        ?>"
        title="DeviantART"
        ng-click="bindByPanel('deviantart')"
        href="javascript:;"><img width="36" src="<?php echo MHttp::desktopHost(); ?>/themes/mobispot/socialmediaicons/deviantart.png"> </a>
    <a class="<?php
        echo (SocInfo::nameInList('instagram', $spotNets))?        'link':''
        ?>"
        title="Instagram"
        ng-click="bindByPanel('instagram_mobile')"
        href="javascript:;"><img width="36" src="<?php echo MHttp::desktopHost(); ?>/themes/mobispot/socialmediaicons/instagram.png"> </a>
                    </div>
            </div>
