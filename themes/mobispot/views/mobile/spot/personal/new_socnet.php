    ...
    <div class="item-area type-itembox">
        <div class="item-head">
            <a href="<?php echo CHtml::encode($content); ?>" class="type-link">
                <img class="soc-icon" src="<?php echo $this->desktopHost(); ?>/themes/mobispot/socialmediaicons/<?php echo $socInfo->getSmallIcon(CHtml::encode($content));?>" height="18"> <span class="link"><?php echo CHtml::encode($content); ?></span>
            </a>
        </div>
