...
<ul id="slides" class="slides-container">
    <li style="background-image:url(/themes/mobispot/new/img/slider/<?php echo $resolution?>/01.jpg); ">
        <div class="container">
            <h1>
    ...
    <li style="background-image:url(/themes/mobispot/new/img/slider/<?php echo $resolution?>/02.jpg);">
    ...
    <li style="background-image:url(/themes/mobispot/new/img/slider/<?php echo $resolution?>/03.jpg);">
        <div class="container">
            <h1>
    ...
    <li style="background-image:url(/themes/mobispot/new/img/slider/<?php echo $resolution?>/04.jpg);">
        <div class="container blue">
            <h1>
