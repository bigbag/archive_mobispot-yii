<div class="first-screen">
    ...
    <footer class="footer-page">
        <ul class="left">
            <li><a href="/readers"><?php echo Yii::t('general', 'Device compatibility'); ?></a></li>
...
<div id="info" class="info-screen">
    ...
    <ul id="infoNav" class="screen-nav">
        <li data-scroll-nav="1"><a href="#payment"><?php echo Yii::t('general', 'Payments'); ?></a></li>
        <li data-scroll-nav="2"><a href="#"><?php echo Yii::t('general', 'Social links'); ?></a></li>
        <li data-scroll-nav="3"><a href="#"><?php echo Yii::t('general', 'Coupons'); ?></a></li>
        <li data-scroll-nav="4"><a href="#"><?php echo Yii::t('general', 'Tickets'); ?></a></li>
        <li data-scroll-nav="5"><a href="#"><?php echo Yii::t('general', 'Work with us'); ?></a></li>
    </ul>
        <div id="devices" class="info-item">
            ...
            <div class="products-list" ng-controller="slideController">
                <article id="slider-wristband" ng-init="">
                                                ...
                                                <p><?php echo Yii::t('general', 'Unique	NFC	wristband	from Mobispot.	Waterproof	and	sexy.'); ?></p>
                                                <ul class="color-list">
                                                        <li ng-click="fadeTo(wristband, 1)" style="background: #0062FF"></li>
                                                        <li ng-click="fadeTo(wristband, 3)" style="background: #5AC0B9" ></li>
                                                        <li ng-click="fadeTo(wristband, 4)" style="background: #d5d850" ></li>
                                                        <li ng-click="fadeTo(wristband, 2)" style="background: #AB2640" ></li>
                                                        <li ng-click="fadeTo(wristband, 12)" style="background: #c7cacc" ></li>
                                                        <li ng-click="fadeTo(wristband, 0)" style="background: #000"></li>
                                                        <li class="wri-p1 wri-pattern" ng-click="fadeTo(wristband, 5)" style="background: #5AC0B9" ></li>
                                                        <li class="wri-p6 wri-pattern" ng-click="fadeTo(wristband, 10)" style="background: #5AC0B9" ></li>
                                                        <li class="wri-p3 wri-pattern" ng-click="fadeTo(wristband, 7)" style="background: #AB2640" ></li>
                                                        <li class="wri-p7 wri-pattern" ng-click="fadeTo(wristband, 11)" style="background: #AB2640" ></li>
                                                        <li class="wri-p4 wri-pattern" ng-click="fadeTo(wristband, 8)" style="background: #000" ></li>
                                                        <li class="wri-p5 wri-pattern" ng-click="fadeTo(wristband, 9)" style="background: #000" ></li>
                                                        <li class="wri-p2 wri-pattern" ng-click="fadeTo(wristband, 6)" style="background: #0062FF" ></li>
                                                ...
                                                <div class="img-wrapper mainimageshell viewwindow">
                                                                ...
                                                                >
                                                                        <li
                                                                                ng-repeat="slide in wristband.slides"
                                                                                class="aslide">
                                                                                <img 
               id="wristband_{{slide.id}}" 
               class="large f-slide"
               ...
               ng-src="/themes/mobispot/img/a_slider/{{slide.img}}" />
                ...
                <article class="left" id="slider-cards">
                                                <h3><?php echo Yii::t('general', 'Card'); ?></h3>
                                                <p><?php echo Yii::t('general', 'Choice of conservative ones. If you get bored - draw something on it.'); ?></p>
                                                <ul class="color-list">
                                                        <li ng-click="fadeTo(cards, 1)" style="background: #0062FF"></li>
                                                        <li ng-click="fadeTo(cards, 2)" style="background: #5AC0B9" ></li>
                                                        <li ng-click="fadeTo(cards, 4)" style="background: #d5d850" ></li>
                                                        <li ng-click="fadeTo(cards, 3)" style="background: #AB2640" ></li>
                                                        <li class="white" ng-click="fadeTo(cards, 5)" style="background: #fff" ></li>
                                                        <li ng-click="fadeTo(cards, 0)" style="background: #000"></li>
                                                </ul>
        
        <div class="img-wrapper mainimageshell viewwindow">
            <ul class="fullsizelist aslide">
                <li
                    ng-repeat="slide in cards.slides"
                    class="aslide">
                        <img 
                            id="cards_{{slide.id}}" 
                            class="large f-slide"
                ...
                <article class="keyfob" id="slider-keyfobs">
                                                <h3><?php echo Yii::t('general', 'Keyfob'); ?></h3>
                                                <p><?php echo Yii::t('general', 'Occupies no space in your pocket but brings all the power of NFC.'); ?></p>
                                                <ul class="color-list">
                                                        <li ng-click="fadeTo(keyfobs, 4)" style="background: #0062FF" ></li>
                                                        <li ng-click="fadeTo(keyfobs, 2)" style="background: #5AC0B9" ></li>
                                                        <li ng-click="fadeTo(keyfobs, 3)" style="background: #d5d850" ></li>
                                                        <li ng-click="fadeTo(keyfobs, 1)" style="background: #AB2640" ></li>
                                                        <li class="white" ng-click="fadeTo(keyfobs, 5)" style="background: #fff" ></li>
                                                        <li ng-click="fadeTo(keyfobs, 0)" style="background: #000"></li>
                                                </ul>
            <div class="img-wrapper mainimageshell viewwindow">
                <ul class="fullsizelist aslide">
                    <li
                        ng-repeat="slide in keyfobs.slides"
                        class="aslide"
                    >
                        <img 
                            id="keyfobs_{{slide.id}}"
                            class="large f-slide"
        ...
        <div class="wrapper">
            <header>
                <h1><?php echo Yii::t('general', 'Pay with a tap, not with cash'); ?></h1>
                <p class="sub-text"><?php echo Yii::t('general', 'Spend less time paying for lunch, spend more time eating it. 
                Mobispot works with your campus payment scheme.'); ?></p>
            </header>
            <article  class="payment-item img-left">
                    <h3><?php echo Yii::t('general', 'Make your wristband pay for you'); ?></h3>
                    ...
                    <p><?php echo Yii::t('general', 'Once registered your Spot link it to your bank card - fast and absolutely secure. Now your wristband’s payment feature is powered.'); ?>
                         </p>
            </article>
        ...
        <div id="soc" class="info-item">
            <header>
                ...
                <p class="sub-text">
                    <?php echo Yii::t('general', 'Met someone? 
                    Share your details instantly with Mobispot. 
                    Like something? 
                    Share it, and brands can share right back.'); ?>
                </p>
            </header>
            <div class="triple">
