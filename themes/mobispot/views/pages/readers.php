...
<div class="content-wrapper">
    <div class="content-block" ng-controller="PhonesController" ng-init="initPhones(<?php echo $phones ?>);initDevices(<?php echo $devices ?>)">
        <div class="row">
            ...
            <p class="red"><?php echo Yii::t('phone', 'Please note: Some devices specifications change regularly and depend on the sales region. For the most accurate information check with your retailer or mobile operator that NFC is enabled on your device.') ?></p>
    </div>
</div>
<div class="fc"></div>