            ...
            <div id="customCard" class="guu-card" ng-controller="SpotController" ng-init="custom_card.token='<?php echo Yii::app()->request->csrfToken ?>'">
                ...
                <div class="row">
                    <div class="column small-6 large-6 large-max">
                            ...
                            <div class="personal-card vertical" ng-style="{'background': 'url(/themes/mobispot/img/' + custom_card.shirt_img + ') 0 0 no-repeat'}"
                                >
                                ...
                                <span class="card-number">#{{custom_card.number}}</span>
                    ...
                    <div class="column small-12 large-12">
                        <form class="custom" id="form-shipping" name="shippingForm">
                            ...
                            <div class="column small-4 large-4">
                                ...
                                <?php if (!empty($card)): ?>
                                    <span ng-init="customCardInit('<?php echo $card; ?>')">
                                    </span>
                                <?php endif;?>
                            </div>
                            ...
                            <div class="column small-4 large-4">
                                ...
                                <a class="form-button button button-round" ng-click="orderCustomCard(custom_card, shippingForm.$valid, '<?php echo Yii::t('spot', 'Заказ оформлен')?>')" href="javascript:;"><?php echo Yii::t('spot', 'ГОТОВО!')?></a>
                            </div>
                        </form>
                    </div>
                </div>
