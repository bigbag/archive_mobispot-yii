...
<div class="row">
  <div class="six columns">
    <form id="help-in" name="helpForm">
      ...
      <textarea name="question" ng-model="user.question" rows="5" placeholder="<?php echo Yii::t('help', 'Question');?> (<?php echo Yii::t('help', 'If you have a suggested answer, please let us know.');?>)" required ></textarea>
