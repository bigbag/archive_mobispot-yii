...
<div class="row">
  <div class="six columns">
    <form id="help-in" name="helpForm">
      <input name='fName' type="text" ng-model="user.fName" placeholder="<?php echo Yii::t('help', 'First Name');?>" maxlength="300" ng-minlength="3" required >
      <input name='lname' type="text" ng-model="user.lname" placeholder="<?php echo Yii::t('help', 'Last name');?>" maxlength="300">
      <input name='email' type="email" ng-model="user.email" placeholder="<?php echo Yii::t('help', 'Email');?>" maxlength="300" ng-minlength="3" required >
