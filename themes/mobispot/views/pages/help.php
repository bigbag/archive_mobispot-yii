...
<div class="row">
  <div class="six columns">
    <form id="help-in" name="helpForm">
      <input name='fName' type="text" ng-model="user.fName" placeholder="<?php echo Yii::t('help', 'First Name');?>" maxlength="300" required >
      <input name='lname' type="text" ng-model="user.lname" placeholder="<?php echo Yii::t('help', 'Last name');?>" maxlength="300">
      <input name='email' type="email" ng-model="user.email" placeholder="<?php echo Yii::t('help', 'Email');?>" maxlength="300" required >
      <input name='phone' type="text" ng-model="user.phone" placeholder="<?php echo Yii::t('help', 'Mobile');?>">
      <textarea name="question" ng-model="user.question" rows="5" placeholder="<?php echo Yii::t('help', 'Question');?> (<?php echo Yii::t('help', 'If you have a suggested answer, please let us know');?>)" ngMinlength="3" ngMaxlength="1024" required ></textarea>

      <div class="form-control">
        <a class="spot-button" href="javascript:;" ng-show="!helpForm.$invalid" ng-click="send(user)"><?php echo Yii::t('help', 'Send');?></a>
      </div>
    </form>
  </div>
</div>
