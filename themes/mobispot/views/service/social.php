        ...
        <div id="registration-block">
            <div id="registration-form">
                <?php if (Yii::app()->user->isGuest): ?>
                    ...
                    <? switch($service_name) {
                      case 'facebook':
                          include('block/_not_auth_facebook.php');
                      break;
                      case 'google_oauth':
                          include('block/_not_auth_google.php');
                      break;
                      case 'twitter':
                          include('block/_not_auth_twitter.php');
                      break;
                      case 'occupied':
                          include('block/_not_auth_occupied.php');
                      break;
                      default:
                          include('block/_not_auth.php');
                      break;
                    }
                    ?>
                <?php else: ?>
