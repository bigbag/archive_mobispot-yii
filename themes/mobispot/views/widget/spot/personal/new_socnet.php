<div class="spot-item spot-block">
  <div class="item-area">
    <p class="item-area item-type__text"><img src="/themes/mobile/images/icons/<?php $socInf = new SocInfo; echo $socInf->getSmallIcon(CHtml::encode($content)); ?>" height="14" width="14" style="display: inline-block;">	 <?php echo CHtml::encode(CHtml::encode($content))?></p>
