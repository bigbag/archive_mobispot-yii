<div class="oneSpotInfo">
    ...
    поясните, зачем Вы собираете эту информацию.<br />');?>
      ...
      <table class="feedbackInfoTbl" cellspacing="0">
            ...
            <td colspan="2">
                <div  class="txt-form">
                    <div  class="txt-form-cl">
                        <input type="text"  class="txt" name="inputtext" value="" placeholder="<?php echo Yii::t('account', 'Введите здесь поясняющий текст к Вашему споту');?>" />
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2"><a href="" class="btn-30"><span class="btn-30-txt"><?php echo Yii::t('account', 'Смотреть отзывы к этому споту');?></span></a></td>
        </tr>
    </table>
</div>
