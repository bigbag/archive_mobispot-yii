<div class="slide-content clearfix">
    <div id="j-settingsForm" class="settings-block" style="display:none;">
        <div class="m-set-content">
            <div class="row">
                <h3><?php echo Yii::t('wallet', 'Настройки'); ?></h3>
                <div class="settings-item sms-set">
                    <div class="toggle-active">
                        <a href="javascript:;" 
                            ...
                            <i class="large"></i>
                            <h3> <?php echo Yii::t('wallet', 'SMS информирование'); ?></h3>
                        </a>
                        <div class="settings-item_form active-sub">
                            <p class="set-description">
                                <?php echo Yii::t('wallet', ' СМС с предупреждением о скорой блокировке кошелька высылается, когда баланс опускается до 50 руб.') ;?>
                            </p>
                            <div class="condition01">
                            <form class="custom">
                                <label><?php echo Yii::t('wallet', '10 цифр, например, 9013214567');?></label>
                                <div class="content-row large-12 left g-clearfix">
                                    <select class="medium" 
                                        ...
                                        <option value="+7">
                                            <?php echo Yii::t('wallet', '+7 Россия'); ?>
                                        </option>
                                    </select>
                                </div>
                                <div class="floatleft">
                                    <input type="text" 
                                        name="phone" 
                                        ng-model="sms.phone" 
                                        placeholder="<?php echo Yii::t('wallet', 'Номер телефона'); ?>" 
                                        ng-init="sms.phone=''" 
                                        maxlength="10"
                                        minlength="10"
                                        ng-minlength="10"
                                    ...
                                    <a id="smsForm" 
                                        ...
                                        <?php echo Yii::t('wallet', 'Сохранить'); ?>
                                    </a>
                                </div>
                            </form>
                            </div>
                ...
                <div id="payment-block">
                        ...
                        <div class="large-12 columns" ng-init="payment.wallet='<?php echo $wallet->id;?>';payment.balance=<?php echo $wallet->balance;?>">
                            <label for="payment">
                                <?php if($wallet->balance<801):?>
                                    <?php echo Yii::t('wallet', 'Введите сумму от 100 до');?> <?php echo (1000-$wallet->balance);?> <?php echo Yii::t('wallet', 'руб.');?>
                                <?php else:?>
                                    <?php echo Yii::t('wallet', 'Вы можете пополнить кошелёк на 100 руб.');?>
                                <?php endif;?>
                            </label>
                        </div>
                    </div>
                    <div class="row form-line">
                        <div class="large-4 columns">
                            <input id="payment" type="text" ng-pattern="/[0-9]+/" ng-model="payment.amount" placeholder="<?php echo Yii::t('wallet', 'сумма,');?>" maxlength="50" required="" class="ng-pristine ng-invalid ng-invalid-required ng-valid-pattern b-pay-input"><span class="right b-currency" ng-init="payment.amount=100;payment.status=<?php echo ($wallet->status);?>"><?php echo Yii::t('wallet', 'руб.');?></span>
                        </div>
                        <div class="large-3 left columns">
                            <a id="add-button" class="spot-button button-disable text-center" href="javascript:;" ng-click="addSumm(payment, $event)"><?php echo Yii::t('wallet', 'Пополнить');?></a><br>
                        </div>
                        <span id="j-wallet" class="settings-button payment-rules right">
                            <?php echo Yii::t('wallet', 'Условия использования и гарантии безопасности');?>
                        </span>
                    </div>
                </div>
                </form>
        ...
        <div class="row" id="auto-payment" ng-init="recurrent.history_id=<?php echo $history_id;?>;newAutoPayment()">
            <div class="m-auto-payment bg-gray <?php echo ($auto)?'active':''?>">
                <div class="large-12 columns">
                        ...
                        <h3><?php echo Yii::t('wallet', 'Автоплатежи');?></h3>
                        <span class="sub-h"><?php echo Yii::t('wallet', 'Система автопополнение баланса при остатке менее') 
                                    . ' '. $limit_autopayment . ' '. Yii::t('wallet', 'руб.');?></span>
                </div>
                <div class="large-12 m-auto-block">
                    <form id="enableReccurent" class="item-area__right custom" style="display: <?php echo ($auto)?'none':'block'?>;" name="recurrentForm">
                        <div class="large-5 columns">
                            <label for="auto-payment"><?php echo Yii::t('wallet', 'C какой карты');?></label>
                            <div class="content-row large-12 left g-clearfix">
                        ...
                        <div class="large-4 columns">
                            <label for="auto-payment"><?php echo Yii::t('wallet', 'Сумма до которой пополнять');?></label>
                            <div class="clearfix form-line">
                                <div class="large-12 columns" ng-init="recurrent.amount=100">
                                    <input id="p1" type="text" ng-pattern="/[0-9]+/" ng-model="recurrent.amount" placeholder="<?php echo Yii::t('wallet', 'сумма,');?>"  maxlength="50" required class="ng-pristine ng-invalid ng-invalid-required ng-valid-pattern b-pay-input"><span class="right b-currency"><?php echo Yii::t('wallet', 'руб.');?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <p class="sub-txt sub-txt-last toggle-active">
                            <a class="checkbox agree" href="javascript:;" ng-click="setRecurrentTerms(recurrent)">
                                <i class="large"></i>
                                <?php echo Yii::t('wallet', '*Включая автоплатежи вы соглашаетесь,
                                что баланс кампусной карты "Мобиспот" будет автоматически пополняться при остатке менее') 
                                    . ' '. $limit_autopayment . ' '. Yii::t('wallet', 'руб.');?>
                            </a>
                        </p>
                        <a class="terms settings-button" href="javascript:;" id="j-settings"><?php echo Yii::t('wallet', 'Условия использования функции "Автопополнение"');?></a>
                    </form>
                    
                    <form id="disableReccurent" class="item-area__left custom" style="display: <?php echo ($auto)?'block':'none'?>;">
                        <div class="m-card-block">
                            <h5><?php echo Yii::t('wallet', 'Автоплатеж будет производится с карты:');?></h5>
                            <div class="m-card-cur m-card_<?php echo (!empty($auto))?PaymentLog::getSystemByPan($auto->card_pan):'uniteller'; ?>">
                                <div id="card_pan"><?php echo Yii::t('wallet', 'Карта: ');?><span class="m-card-info" id="auto-payment-card"><?php echo (!empty($auto))?$auto->card_pan:'';?></span></div>
                                <div id="card_date"><?php echo Yii::t('wallet', 'Дата подключения: ');?><span class="m-card-info" id="auto-payment-date"><?php echo (!empty($auto))?$auto->creation_date:''?></span></div>
                            </div>
                        </div>
                        <div>
                            <div class="large-5 input-sum columns">
                                <h5><?php echo Yii::t('wallet', 'Сумма до которой будет пополняться:');?></h5>
                                <div class="clearfix form-line">
                                    <div class="large-12 columns text-right">
                                            <span class="m-card-info"><span id="auto-payment-summ"><?php echo (!empty($auto))?$auto->amount:''?></span><span class="right b-currency"><?php echo Yii::t('wallet', 'руб.');?></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="large-3 apay-button columns">
                        <a id="buttonApayOn" class="spot-button text-center on-apay button-disable" href="javascript:;" ng-click="enable_recurrent(recurrent, recurrentForm.$valid)"><?php echo Yii::t('wallet', 'Включить');?></a>
                        <a id="buttonApayOff" class="spot-button text-center off-apay" href="javascript:;" ng-click="disable_recurrent(payment.wallet)"><?php echo Yii::t('wallet', 'Отключить');?></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="m-table-wrapper">
                    <table id="actions-table" class="m-spot-table" ng-grid="gridOptions">
                        ...
                        <tr>
                            ...
                            <th><div><span><?php echo Yii::t('wallet', 'Бонус');?></span></div></th>
                        </tr>
                        </thead>
                        <tbody>
