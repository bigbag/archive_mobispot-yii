                ...
                <?php if (!Yii::app()->user->isGuest): ?>
                    <ul class="login-bar">
                        ...
                        <?php if (isset(Yii::app()->controller->module) && (Yii::app()->controller->module->id == 'store')): ?>
                            <li ng-controller="UserCtrl" ng-init="initTimer(<?php if ((Yii::app()->controller->action->id == 'index') && (Yii::app()->controller->id == 'product'))
                        echo '1000';
                    else
                        echo '10000';
                    ?>)" ng-show="itemsInCart > 0"><a href="/store/product/cart">Shopping bag({{itemsInCart}})</a></li>
    ...
    <?php endif; ?>
                    ...
                    <ul class="login-bar">
                        <li ng-controller="UserCtrl" ng-init="initTimer(<?php if ((Yii::app()->controller->action->id == 'index') && (Yii::app()->controller->id == 'product'))
                            ...
                            echo '10000';
                        ?>)"><a href="/store/product/cart" ng-show="itemsInCart > 0">Shopping bag({{itemsInCart}})</a></li>
                    </ul>
<?php elseif ($this->getCart()): ?>
                    <ul class="login-bar">
                        <li><a href="/store/product/cart"><?php echo Yii::t('menu', 'Shopping bag') ?>(<?php echo $this->getCart(); ?>)</a></li>
