                            ...
                            <center>
                                <div class="txt-form">
                                    <div class="txt-form-cl">
                                        <input type="text" name="LoginCaptchaForm[email]" style="width:100%;"
                                               class="txt"
                                               value="" placeholder="<?php echo Yii::t('user', 'E-mail')?>"
                                               autocomplete="off"/>
                                ...
                                <div class="txt-form">
                                    <div class="txt-form-cl">
                                        <input type="password" name="LoginCaptchaForm[password]" style="width:100%;"
                                               class="txt" value="" placeholder="<?php echo Yii::t('user', 'Пароль')?>"
                                               autocomplete="off"/>
                                    </div>
                                </div>
                            </center>
