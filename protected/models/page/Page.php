...
class Page extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('category_id, creation_date, change_date, user_id, title, slug, body, pattern', 'required'),
            ...
            array('slug', 'unique'),
            array('id, category_id, creation_date, change_date, user_id, title, slug, body, pattern, keywords, description, status', 'safe', 'on' => 'search'),
        );
    }
