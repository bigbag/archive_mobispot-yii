...
(function ($) {
    ...
    Redactor.prototype = {
        ...
        start:function () {
            ...
            $(this.doc).click($.proxy(function (e) {
                this.$editor.focus();
            }, this));
        ...
        buildToolbar:function () {
            ...
            $.each(RTOOLBAR[this.opts.toolbar], $.proxy(function (key, s) {
                ...
                if (key == 'backcolor' || key == 'fontcolor' || typeof(s.dropdown) != 'undefined') {
                    ...
                    // observing dropdown
                    this.hdlHideDropDown = $.proxy(function (e) {
        ...
        buildButton:function (key, s) {
            ...
            if (typeof(s.func) == 'undefined') button.click($.proxy(function () {
                this.execCommand(s.exec, key);
            }, this));
            else if (s.func != 'show') button.click($.proxy(function (e) {
                this[s.func](e);
            }, this));
            ...
            $.each(obj, $.proxy(
                function (x, d) {
                    ...
                    if (d.name == 'separator') drop_a = $('<a class="redactor_separator_drop">');
                        ...
                        if (typeof(d.func) == 'undefined') $(drop_a).click($.proxy(function () {
                            this.execCommand(d.exec, x);
                        }, this));
                        else $(drop_a).click($.proxy(function (e) {
                            this[d.func](e);
                        }, this));
                    }
