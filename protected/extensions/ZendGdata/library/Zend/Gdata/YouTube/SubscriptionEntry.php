 ...
 */
require_once dirname(__FILE__).'/Extension/PlaylistTitle.php';

/**
 * @see Zend_Gdata_YouTube_Extension_PlaylistId
 */
require_once dirname(__FILE__).'/Extension/PlaylistId.php';
 ...
 */
require_once dirname(__FILE__).'/Extension/CountHint.php';

/**
 * @see Zend_Gdata_YouTube_Extension_QueryString
 */
require_once dirname(__FILE__).'/Extension/QueryString.php';
