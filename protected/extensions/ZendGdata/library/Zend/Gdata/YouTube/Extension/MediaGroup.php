 ...
 */
require_once dirname(__FILE__).'/../../Media/Extension/MediaGroup.php';
 ...
 */
require_once dirname(__FILE__).'/Duration.php';
 ...
 */
require_once dirname(__FILE__).'/VideoId.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Uploaded
 */
require_once dirname(__FILE__).'/Uploaded.php';
