 ...
 */
require_once dirname(__FILE__).'/../Extension/Comments.php';
 ...
 */
require_once dirname(__FILE__).'/MediaEntry.php';

/**
 * @see Zend_Gdata_YouTube_Extension_MediaGroup
 */
require_once dirname(__FILE__).'/Extension/MediaGroup.php';

/**
 * @see Zend_Gdata_YouTube_Extension_NoEmbed
 */
require_once dirname(__FILE__).'/Extension/NoEmbed.php';
 ...
 */
require_once dirname(__FILE__).'/Extension/Link.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Racy
 */
require_once dirname(__FILE__).'/Extension/Racy.php';

/**
 * @see Zend_Gdata_Extension_Rating
 */
require_once dirname(__FILE__).'/../Extension/Rating.php';

/**
 * @see Zend_Gdata_Geo_Extension_GeoRssWhere
 */
require_once dirname(__FILE__).'/../Geo/Extension/GeoRssWhere.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Control
 */
require_once dirname(__FILE__).'/Extension/Control.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Recorded
 */
require_once dirname(__FILE__).'/Extension/Recorded.php';
