 ...
 * @see Zend_Gdata
 */
require_once dirname(__FILE__).'/../Gdata.php';
 ...
 */
require_once dirname(__FILE__).'/Extension/OpenSearchTotalResults.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchStartIndex
 */
require_once dirname(__FILE__).'/Extension/OpenSearchStartIndex.php';

/**
 * @see Zend_Gdata_Extension_OpenSearchItemsPerPage
 */
require_once dirname(__FILE__).'/Extension/OpenSearchItemsPerPage.php';
