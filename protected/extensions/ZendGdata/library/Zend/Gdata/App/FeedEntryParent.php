...
*/
require_once dirname(__FILE__).'/Extension/Element.php';

/**
 * @see Zend_Gdata_App_Extension_Author
*/
require_once dirname(__FILE__).'/Extension/Author.php';

/**
 * @see Zend_Gdata_App_Extension_Category
*/
require_once dirname(__FILE__).'/Extension/Category.php';

/**
 * @see Zend_Gdata_App_Extension_Contributor
*/
require_once dirname(__FILE__).'/Extension/Contributor.php';

/**
 * @see Zend_Gdata_App_Extension_Id
 */
require_once dirname(__FILE__).'/Extension/Id.php';
 ...
 */
require_once dirname(__FILE__).'/Extension/Rights.php';

/**
 * @see Zend_Gdata_App_Extension_Title
 */
require_once dirname(__FILE__).'/Extension/Title.php';

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
require_once dirname(__FILE__).'/Extension/Updated.php';
