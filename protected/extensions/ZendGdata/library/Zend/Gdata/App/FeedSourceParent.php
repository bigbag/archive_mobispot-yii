 ...
 */
require_once dirname(__FILE__).'/Extension/Generator.php';

/**
 * @see Zend_Gdata_App_Extension_Icon
 */
require_once dirname(__FILE__).'/Extension/Icon.php';

/**
 * @see Zend_Gdata_App_Extension_Logo
 */
require_once dirname(__FILE__).'/Extension/Logo.php';

/**
 * @see Zend_Gdata_App_Extension_Subtitle
 */
require_once dirname(__FILE__).'/Extension/Subtitle.php';
