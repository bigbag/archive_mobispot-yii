 ...
 */
require_once dirname(__FILE__).'/FeedEntryParent.php';

/**
 * @see Zend_Gdata_App_Extension_Content
 */
require_once dirname(__FILE__).'/Extension/Content.php';

/**
 * @see Zend_Gdata_App_Extension_Edited
 */
require_once dirname(__FILE__).'/Extension/Edited.php';

/**
 * @see Zend_Gdata_App_Extension_Published
 */
require_once dirname(__FILE__).'/Extension/Published.php';

/**
 * @see Zend_Gdata_App_Extension_Source
 */
require_once dirname(__FILE__).'/Extension/Source.php';

/**
 * @see Zend_Gdata_App_Extension_Summary
 */
require_once dirname(__FILE__).'/Extension/Summary.php';
