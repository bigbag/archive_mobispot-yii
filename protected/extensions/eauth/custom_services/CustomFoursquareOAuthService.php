...
class CustomFoursquareOAuthService extends EOAuth2Service {    
  ...
  protected function fetchAttributes() {
    ...
    $info = (array)$this->makeRequest('https://api.foursquare.com/v2/users/self?oauth_token='.$token.'&v=20140203', array(), true);
    ...
    $socToken=SocToken::model()->findByAttributes(array(
        ...
        'type'=>SocToken::TYPE_FOURSQUARE,
    ));
    if(!$socToken)
        $socToken = new SocToken;
    $socToken->type = SocToken::TYPE_FOURSQUARE;
